...
$TorNetworkStatus_Version = "3.5";

// ++++++++++ Tor Connection ++++++++++ {{{

$LocalTorServerIP = "192.168.1.220";
...
// Comment out the following line if you do not provide WHOIS service
...
// ++++++++++ Mirrors ++++++++++ {{{
$myMirrorName = "kgprog";
$mirrorList = '<a href="http://torstatus.blutmagie.de/" class="plain">blutmagie</a> | <a href="http://torstatus.grepular.com/" class="plain">grepular</a>';
